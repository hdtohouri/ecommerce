<div class="modal fade" id="desactivate-admin-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered" data-backdrop="static">
        <form class="modal-content" action="<?php echo base_url('common/adminspace/dashboard/list_admin') ?>" method="post" id="add_category_form">
